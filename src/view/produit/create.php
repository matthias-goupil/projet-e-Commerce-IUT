  <main>  
    <form <?php if ($_GET['action'] == "update"){
              echo "action= '?controller=Produit&action=updated&idproduit=".rawurlencode($p->get('idproduit'))."'";
            } else {
        ...
        name="urlImage1" id="urlImage1" <?php if($_GET['action'] == "update"){
                                                             echo "value= '".htmlspecialchars($p->get('urlImage1'))."'";}?>required/>
